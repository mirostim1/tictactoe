...
class GameController extends Controller
{
    public function board(Request $request, $id) {
        ...
        $locations = [
            1 => ['class' => 'top left', 'checked' => false, 'type' => ''],
            2 => ['class' => 'top middle', 'checked' => false, 'type' => ''],
            3 => ['class' => 'top right', 'checked' => false, 'type' => ''],
            4 => ['class' => 'center left', 'checked' => false, 'type' => ''],
            5 => ['class' => 'center middle', 'checked' => false, 'type' => ''],
            6 => ['class' => 'center right', 'checked' => false, 'type' => ''],
            7 => ['class' => 'bottom left', 'checked' => false, 'type' => ''],
            8 => ['class' => 'bottom middle', 'checked' => false, 'type' => ''],
            9 => ['class' => 'bottom right', 'checked' => false, 'type' => ''],
        ];
    ...
    public function play(Request $request, $id) {
        ...
        event(new Play($id, $turn->type, $location, $user->id, $otherPlayerId));
